  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <Script id="inspectlet" strategy="beforeInteractive">
          {`
            (function() {
              window.__insp = window.__insp || [];
              __insp.push(['wid', 1411423155]);
              var ldinsp = function(){
                ...
                insp.async = true;
                insp.id = "inspsync";
                insp.src = ('https:' == document.location.protocol ? 'https' : 'http') + '://cdn.inspectlet.com/inspectlet.js?wid=1411423155&r=' + Math.floor(new Date().getTime()/3600000);
