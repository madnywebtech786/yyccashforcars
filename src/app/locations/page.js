...
export const metadata = {
  title: "Locations - YYC Cash for Cars",
  description:
    "Explore the Alberta cities served by YYC Cash for Cars, including Airdrie, Canmore, Chestermere, Cochrane, Drumheller, High River, Lethbridge, Okotoks, and Strathmore.",
